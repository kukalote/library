...
class Geohash {
    ...
    public function neighbors($srcHash) {
         ...
         */
        $str_neibhbor = '';
        $str_neibhbor .= "'" . $srcHash . "',";
        $str_neibhbor .= "'" . $neighbors['top'] . "',";
        $str_neibhbor .= "'" . $neighbors['bottom'] . "',";
        $str_neibhbor .= "'" . $neighbors['right'] . "',";
        $str_neibhbor .= "'" . $neighbors['left'] . "',";
        $str_neibhbor .= "'" . $this->calculateAdjacent($neighbors['left'], 'top') . "',";
        $str_neibhbor .= "'" . $this->calculateAdjacent($neighbors['right'], 'top') . "',";
        $str_neibhbor .= "'" . $this->calculateAdjacent($neighbors['right'], 'bottom') . "',";
        $str_neibhbor .= "'" . $this->calculateAdjacent($neighbors['left'], 'bottom') . "'";
        return $str_neibhbor;
    }
     ...
     * Author: Bruce Chen (weibo: @一个开发者)
     * @param float $lat 纬度 posY
     * @param float $lng 经度 posX
     */
